...
building_reader=csv.reader(open("/Users/nancysackman/Code/UW.HOLY..ENN.2001.059.18.54.00.000-2001.059.19.00.00.000.csv"))
...
cdc=2*math.sqrt(k*m)*.25 #critical damping coefficient 2*squareroot of k*m
